...
func _ready() -> void:
	...
	# position ∈ [0, 9], amplitude ∈ [0, 8], frequency ∈ [1, DON'T GO TO UP PAST 16!)
	...
	# amplitude: Array[10] of values ∈ [0, 8], frequency ∈ [1, DON'T GO TO UP PAST 16!)
	...
	# startPosition ∈ [0, 8], endPosition ∈ [startPosition+1, 9], firstFoot ∈ [0, 6], secondFoot ∈ [firstFoot+1, 7], frequency ∈ [1, DON'T GO TO UP PAST 16!)
	Trigger.Galloping("r", 1, 7, 2, 4, 8)

	# startPosition ∈ [0, 8], endPosition ∈ [startPosition, 9], amplitudeA, amplitudeB ∈ [0, 7], frequency ∈ [1, DON'T GO TO UP PAST 16!) ∈ [1, ∞), period ∈ [0, 255]
